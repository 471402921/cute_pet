...
mixin _$TemplateItem {
 ...
 String get id; String get name; TemplateStatus get status;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TemplateItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status));
}
...
@override
String toString() {
  return 'TemplateItem(id: $id, name: $name, status: $status)';
}
...
@useResult
$Res call({
 String id, String name, TemplateStatus status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  TemplateStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TemplateItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  TemplateStatus status)  $default,) {final _that = this;
switch (_that) {
case _TemplateItem():
return $default(_that.id,_that.name,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  TemplateStatus status)?  $default,) {final _that = this;
switch (_that) {
case _TemplateItem() when $default != null:
return $default(_that.id,_that.name,_that.status);case _:
  return null;
...
class _TemplateItem implements TemplateItem {
  const _TemplateItem({required this.id, required this.name, this.status = TemplateStatus.active});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TemplateItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status));
}
