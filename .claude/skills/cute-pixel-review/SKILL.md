...
description: >
  ...
  当用户想检查代码是否还守得住架构、未来开发会不会越来越难懂、文档与代码是否对得上时使用此 Skill。
  触发场景包括:用户说 /cute-pixel-review、/cute-pet-review(legacy)、"审一下 features/health"、"看看代码漂没漂移"、
  "review 这个模块"、"检查代码合规"、"未来好维护吗"等。
